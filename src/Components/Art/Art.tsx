...
export default function Art() {
    ...
    const breakpointColumnsObj = {
        default: 3, // if the width of the viewport is larger than 1100px, it will display 3 columns
        1100: 3,
        700: 2, // if the width of the viewport is between 700px and 1100px, it will display 2 columns
        500: 2  // if the width of the viewport is less than 500px, it will display 2 column
    };
